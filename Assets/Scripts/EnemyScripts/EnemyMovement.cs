...
public class EnemyMovement : MonoBehaviour
{
    ...
    [SerializeField, Tooltip("Max Point Top")] 
    public float spawnPoint;
    [SerializeField, Tooltip("Yes =going top No= going down")] 
    public bool _topOrDown;
    [SerializeField, Tooltip("Minimum distance between enemies")] 
    public float minDistanc;
    [SerializeField, Tooltip("!!!Must be less than SpawnPoint!!! Maximum sistance between enemies")] 
    public float maxDistanc;
